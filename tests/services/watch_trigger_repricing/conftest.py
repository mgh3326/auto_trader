...
# 2026-08-18 is the Tuesday of the real incident and a genuine XKRX
# session (asserted in test_gate.py, so this replay is never vacuous).
# 09:05 KST is when the Samsung ladder fired.
...
def uuid_for(index: int) -> str:
    """A real UUID string, so DB-backed tests can reuse the same helpers."""
