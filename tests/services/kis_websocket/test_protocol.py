...
from app.services.kis_websocket import KISExecutionWebSocket, KISSubscriptionAckError
...
def test_kis_subscription_ack_error_properties():
    ...
    error = KISSubscriptionAckError(
        tr_id="TR1", rt_cd="1", msg_cd="MSG1", msg1="Failure"
    )
...
def test_validate_subscription_ack_failure_raises_custom_error():
    ...
    parsed = {
        "header": {"tr_id": "H0STCNI0"},
        "body": {"rt_cd": "1", "msg_cd": "OPSP0011", "msg1": "Invalid key"},
    }
