...
GUARDED_FILES: tuple[pathlib.Path, ...] = (
    ...
    # ROB-1115 strategy-memory write/read boundary.
    REPO_ROOT / "app" / "services" / "strategy_learning_event_service.py",
    REPO_ROOT / "app" / "models" / "strategy_learning_event.py",
    REPO_ROOT / "app" / "schemas" / "strategy_learning_event.py",
