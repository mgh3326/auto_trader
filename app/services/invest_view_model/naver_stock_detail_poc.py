    ...
    if market == "us":
        ...
        endpoints = [
            StockDetailNaverEndpointProbe(
                ...
                url=page_url,
                status="page_candidate",
                payloadFields=["current price", "change", "market", "delay/freshness labels"],
            ...
            StockDetailNaverEndpointProbe(
                ...
                status="verified_200",
                payloadFields=["flashNews[].title", "flashNews[].url", "flashNews[].leadtext", "press"],
            ...
            StockDetailNaverEndpointProbe(
                ...
                status="page_candidate",
                payloadFields=["annual/quarter finance rows", "PER/PBR/ROE", "dividend labels"],
                mappedFields=["valuation", "profile", "sourceFreshness"],
            ...
            StockDetailNaverEndpointProbe(
                ...
                payloadFields=["rankTime", "totalCount", "itemCodes", "comment-count/reaction metadata"],
