...
def register_trade_retrospective_tools(mcp: Any) -> None:
    _ = mcp.tool(
        ...
        description=(
            ...
            "guardrail_block, stop_loss, missed_opportunity}. When trigger_type is set, a non-empty next_actions "
    ...
    _ = mcp.tool(
        ...
        description=(
            ...
            "ROB-1017: missed-opportunity D0->D+5 returns are excluded from "
            "realized-trade strategy/day groups and exposed separately in "
            "missed_cohort (scored/pending counts, positive-opportunity rate, "
            "average opportunity return); trigger_type grouping still includes them. "
