...
def register_forecast_tools(mcp: Any) -> None:
    _ = mcp.tool(
        ...
        description=(
            ...
            "'target_price'; for 'terminal_close' use direction in {up, down}, "
            ...
            "policy also requires target_to_close_factor plus review-date "
            "adjustment_provenance. probability in [0,1], review_date "
            "(YYYY-MM-DD). "
    ...
    _ = mcp.tool(
        ...
        description=(
            ...
            "daily OHLCV as window high/low touches (ROB-639 DB-first, "
            ...
            "review-date candle and explicit-factor-v1 corporate-action "
