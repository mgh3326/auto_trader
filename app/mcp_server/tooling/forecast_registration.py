...
def register_forecast_tools(mcp: Any) -> None:
    ...
    _ = mcp.tool(
        ...
        description=(
            ...
            "'closed_no_claim'). "
            "Manually resolvable non-price kinds and versioned price_target "
            "forecasts requiring an override need an explicit forecast_id plus "
            "manual_outcome (bool) and manual_evidence. A versionless "
            "price_target cannot be manually overridden; register a new forecast "
            "with a typed target. "
