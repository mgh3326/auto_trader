...
class PendingOrder(Base):
    ...
    market: Mapped[str] = mapped_column(String(16), nullable=False)  # equity_kr | equity_us | crypto
    venue: Mapped[str] = mapped_column(String(32), nullable=False)  # kis_mock | upbit | ...
    ...
    status: Mapped[str] = mapped_column(String(32), nullable=False)  # open | partial_fill
