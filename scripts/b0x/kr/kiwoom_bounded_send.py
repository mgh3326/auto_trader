...
PRESEND_RECHECK_ACCOUNT_TRUTH_UNAVAILABLE: Final[str] = (
    "PRESEND_RECHECK_ACCOUNT_TRUTH_UNAVAILABLE"
)
PRESEND_RECHECK_PREFLIGHT_NOT_CLEAN: Final[str] = "PRESEND_RECHECK_PREFLIGHT_NOT_CLEAN"
PRESEND_RECHECK_WRITER_LEASE_LOST: Final[str] = "PRESEND_RECHECK_WRITER_LEASE_LOST"
PRESEND_RECHECK_OWN_ORDER_JOURNAL_UNREADABLE: Final[str] = (
    "PRESEND_RECHECK_OWN_ORDER_JOURNAL_UNREADABLE"
)
PRESEND_RECHECK_MUTATION_BOUNDARY_READ_UNAVAILABLE: Final[str] = (
    "PRESEND_RECHECK_MUTATION_BOUNDARY_READ_UNAVAILABLE"
)
PRESEND_RECHECK_FOREIGN_SAME_DAY_ORDERS_PRESENT: Final[str] = (
    "PRESEND_RECHECK_FOREIGN_SAME_DAY_ORDERS_PRESENT"
)
PRESEND_RECHECK_ORDERING_PREFLIGHT_NOT_CLEAN: Final[str] = (
    "PRESEND_RECHECK_ORDERING_PREFLIGHT_NOT_CLEAN"
)
UNCLASSIFIED_POST_CONSUMPTION: Final[str] = "UNCLASSIFIED_POST_CONSUMPTION"
