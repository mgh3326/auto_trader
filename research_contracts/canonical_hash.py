"""Neutral stdlib-only canonical identity authority for research artifacts.
...
Intentionally stdlib-only. The application-facing ROB-846 module re-exports
this implementation so persisted JSONB AST bytes and experiment IDs remain
unchanged while isolated research configuration can use the same authority.
"""
