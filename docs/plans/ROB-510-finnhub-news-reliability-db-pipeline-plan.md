...
- [x] **Step 1: `_stored_to_article` 일반화**
...
- [x] **Step 2: `_maybe_enqueue_judgment` market 스레딩**
...
- [x] **Step 3: `_kr_persist_and_load` → `_persist_and_load` 일반화**
...
- [x] **Step 1: 기존 US envelope 테스트 확인 후 신규 테스트 추가**
...
- [x] **Step 2: CLAUDE.md ROB-491 섹션에 한 줄 추가**
...
- [x] **Step 1: lint/format/typecheck (app + tests 둘 다 — CI 교훈)**
...
- [x] **Step 2: 관련 테스트 전수 (부모 디렉토리 포함 — ROB-345 교훈)**
