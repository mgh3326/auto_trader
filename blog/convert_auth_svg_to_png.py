"""
인증(Authentication) SVG를 PNG로 변환하는 스크립트
...
async def main():
    ...
    svg_files = [
        ("auth_thumbnail.svg", "auth_thumbnail.png", 1200),
        ("auth_architecture.svg", "auth_architecture.png", 1400),
        ("auth_role_hierarchy.svg", "auth_role_hierarchy.png", 1200),
    ]

    print("🎨 인증 SVG to PNG 변환 시작...\n")
