...
async def main():
    ...
    svg_files = [
        ("monitoring_thumbnail.svg", "monitoring_thumbnail.png", 1200),
        ("before_after_monitoring.svg", "before_after_monitoring.png", 1200),
        ("monitoring_architecture.svg", "monitoring_architecture.png", 1400),
    ]

    print("🎨 SVG to PNG 변환 시작...\n")
