...
PARENT_CONTENT_SHA256 = "4bcc2da979b47caa45b5f90a09c326aefff91fa605e110d55ef316d53c9a9351"
PARENT_MANIFEST_SHA256 = "0767b44f976bf717cdc26bbcb0d01da1800418668f9f153461ce62486de10721"
...
class DerivedManifest:
    ...
    def __post_init__(self) -> None:
        ...
        _int(self.context_start, "context_start"); _int(self.context_end, "context_end")
        ...
        if (self.window_start_iso, self.window_end_iso) != (WINDOW_START_ISO, WINDOW_END_ISO):
            raise ValueError("source window is frozen")

    @classmethod
    def create(cls, *, input_hash: str, context_start: int, context_end: int) -> "DerivedManifest":
        return cls(PARENT_CONTENT_SHA256, PARENT_MANIFEST_SHA256, input_hash, context_start, context_end)

    def to_dict(self) -> dict[str, object]:
        return {"schema_version": self.schema_version, "parent_content_sha256": self.parent_content_sha256,
                "parent_manifest_sha256": self.parent_manifest_sha256, "window_start_iso": self.window_start_iso,
                "window_end_iso": self.window_end_iso, "universe": list(self.universe), "input_hash": self.input_hash,
                "context_start": self.context_start, "context_end": self.context_end,
                "contracts": {"bars": "UTC complete-only 4h", "vwap": "12h/24h contiguous minute typical-price", "gap": "reset", "pit": "raw completed past only"},
